...
export default function Privacy() {
  return (
    <div className="relative min-h-screen bg-[#030806] text-[#ECEFEF] pt-32 pb-24 px-6 md:px-12">
      ...
      <div className="max-w-4xl mx-auto relative z-10 glass-card border border-white/10 rounded-[30px] p-8 md:p-12 shadow-xl">
        <h1 className="font-serif text-3xl md:text-5xl font-bold text-[#ECEFEF] mb-6">Privacy Policy</h1>
        <p className="text-sm text-[#ECEFEF]/50 mb-8">Last Updated: July 2026</p>

        <div className="space-y-6 text-[#ECEFEF]/85 text-sm md:text-base leading-relaxed">
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#ECEFEF] mb-3">1. Information We Collect</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#ECEFEF] mb-3">2. How We Use Your Information</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#ECEFEF] mb-3">3. Data Sharing & Privacy</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#ECEFEF] mb-3">4. Security</h2>
            <p>
          ...
          <section>
            <h2 className="font-serif text-2xl font-bold text-[#ECEFEF] mb-3">5. Contact Us</h2>
            <p>
              If you have any questions or concerns regarding our privacy policies, feel free to contact us at: <a href="mailto:hello@auracoco.in" className="text-gold font-semibold hover:text-brandgreen transition-colors">hello@auracoco.in</a>.
            </p>
          </section>
        </div>
      </div>
